...
export function Component(nameOrTarget: string | Target, propertyKey?: string,
    ...
    if (typeof nameOrTarget !== "string") {
        ...
        if (typeof nameOrTarget === "function" && !propertyKey && nameOrTarget["prototype"]) {
            ...
            defineMetadata(_COMPONENT_TYPE_, IocComponentType.COMPONENT, nameOrTarget)(true);
            ...
            defineMetadata(_COMPONENT_TYPE_, IocComponentType.COMPONENT, nameOrTarget, propertyKey)(true);
            /**
             * Components created by functions of factory have default scope SINGLETON
             */
            defineMetadata(_DEFAULT_SCOPE_, IocComponentScope.SINGLETON, nameOrTarget, propertyKey)(true);
        ...
        return function (target: any, propertyKey?: string, descriptor?: PropertyDescriptor) {
            ...
            if (typeof target === "function" && !propertyKey) {
                ...
                defineMetadata(_COMPONENT_TYPE_, IocComponentType.COMPONENT, target)(true);
                ...
                defineMetadata(_COMPONENT_TYPE_, IocComponentType.COMPONENT, target, propertyKey)(true);
                /**
                 * Method component are components generated by factory
                 * these components are always Singleton?
                 */
                defineMetadata(_DEFAULT_SCOPE_, IocComponentScope.SINGLETON, target, propertyKey)(true);
 ...
 * @makeComponentDecorator(_SPECIAL_TYPE_, IocComponentScope.SINGLETON)("myservice")
 * or
 * @makeComponentDecorator(_SPECIAL_TYPE_, IocComponentScope.SINGLETON)  for unnamed component
 */
